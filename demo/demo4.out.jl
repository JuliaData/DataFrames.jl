...
GroupedDataFrame 
  parent: DataFrame  50 observations of 3 variables
    a: DataVectortortor{ASCIIString}(50) ["B","C","J","I"]
    b: DataVectortortor{ASCIIString}(50) ["a","b","b","e"]
    x: DataVectortortor{Float64}(50) [-0.9161768852275985,0.48376352282942453,0.7267382683529503,1.0790964781651111]
...
SubDataFrame  10 observations of 3 variables
  a: DataVectortortor{ASCIIString}(10) ["B","I","F","G"]
  b: DataVectortortor{ASCIIString}(10) ["a","a","a","a"]
  x: DataVectortortor{Float64}(10) [-0.9161768852275985,-0.02752775061478325,-2.5878352798283024,0.03171114873790696]

julia> idump(gd[1])
SubDataFrame 
  parent: DataFrame 
    columns: Array(Any,(3,))
      1: DataVectortortor{ASCIIString} 
        ...
        replaceVal: ASCIIString 
          data: Array(Uint8,(0,)) []
      2: DataVectortortor{ASCIIString} 
