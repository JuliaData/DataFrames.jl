...
##
## AbstractDataVec's are an abstract type that support NA's and ref()/assign()
...
type DataVec{T} <: AbstractDataVec{T}
    ...
    # function DataVec{T}(new_data::Vector{T}, is_missing::BitVector{Bool})
...
# Initialized constructors with 0's, 1's, false's or true's
