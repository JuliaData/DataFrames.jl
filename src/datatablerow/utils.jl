...
function hashrows(dt::AbstractDataFrame)
...
row_group_slots(dt::AbstractDataFrame, groups::Union{Vector{Int}, Void} = nothing) =
...
function group_rows(dt::AbstractDataFrame)
...
function Base.getindex(gd::RowGroupDict, dtr::DataFrameRow)
