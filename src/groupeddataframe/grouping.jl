...
The shape of the resulting `GroupedDataFrame` is determined using the following rules:
...
The shape of the resulting `DataFrame` is determined using the following rules:
